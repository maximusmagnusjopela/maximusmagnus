...
SITE_URL = "http://maximusmagnus.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://maximusmagnus.com/"
BLOG_EMAIL = "jopela@maximusmagnus.com"
BLOG_DESCRIPTION = "An exultation to all men to strive for excellence."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Maximus Magnus &copy; {date}         <a href="mailto:{email}">{author}</a> {license}'
